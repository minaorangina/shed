...
var rankNames = []string{"NullRank", "Ace", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Jack", "Queen", "King"}
...
var suitNames = []string{"NullSuit", "Clubs", "Diamonds", "Hearts", "Spades"}
